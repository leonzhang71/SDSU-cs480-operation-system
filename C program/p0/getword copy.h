/* getword.h - header file for the getword() function; similar to that used in
   a series of CS480 programs, SDSU.
  ...
  can be found in ~cs480/One/getword.h, to be used with p1, p2, and p4.  It is
  useful to read the more complete getword.h code, to better understand what the
  following declarations do.  But note that ~cs480/One/getword.h describes more
  *and different* functionality than what is required for p0.  See ~cs480/program0
