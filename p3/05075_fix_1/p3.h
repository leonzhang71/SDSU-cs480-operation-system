/* p3.h
   Program 3 CS480 Fall 2021 SDSU

   This is the header file for cs480 Fall 2021 assignment p3.
   See the assignment file ~cs480/program3 for more information.
 ...
 * Name: printeger
 * Purpose: does a formatted (width 6) print of an integer (no \n) to
   stdout.
 ...
 * References: SDSU CS480 p3 assignment. See also
